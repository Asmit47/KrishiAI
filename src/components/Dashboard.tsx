...
const Dashboard: React.FC<DashboardProps> = ({ language, onNavigateToTab }) => {
  const translations = {
    ...
    te: {
      ...
      quickDiseaseDetection: "త్వరిత వ్యాధి గుర్తింపు",
      scanPlantNow: "ఇప్పుడే మొక్కను స్కాన్ చేయండి",
      uploadImage: "చిత్రాన్ని అప్‌లోడ్ చేయండి",
      detectDiseases: "AI-శక్తితో కూడిన చిత్ర విశ్లేషణతో తక్షణమే మొక్కల వ్యాధులను గుర్తించండి",
      ...
      cropsGrowing: "పంటలు పెరుగుతున్నాయి",
